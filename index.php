  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="index.php" class="logo">
        ...
        <span class="logo-lg"><b>Rival</b>Coffe</span>
      </a>
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                <img src="image/student.png" class="user-image" alt="User Image">
    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="header">Beli Barang</li>
          <li><a href="index.php?page=supplier"><i class="fa  fa-info-circle"></i> <span>Supplier</span> </span></a></li>
    ...
    <footer class="main-footer">
      <strong>Copyright &copy; 2019 Rival Coffe</li>.</strong> All rights
      reserved.
    </footer>
